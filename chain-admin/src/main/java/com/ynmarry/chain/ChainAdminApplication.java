...
@MapperScan("com.ynmarry.chain.dao")
@SpringBootApplication(scanBasePackages ="com.ynmarry")

public class ChainAdminApplication {

    public static void main(String[] args) {
        SpringApplication.run(ChainAdminApplication.class, args);
    }
