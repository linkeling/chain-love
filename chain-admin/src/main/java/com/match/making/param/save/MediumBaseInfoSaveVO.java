...
@ApiModel(description = "红娘基本信息表VO")
public class MediumBaseInfoSaveVO extends BaseVO {
    /** 主键id */
    ...
    @Length(max=40, message = "红娘编号不能大于40")
    private String orderId;
    /** 姓名 */
    @ApiModelProperty(value = "姓名", position = 3 )
    @Length(max=20, message = "姓名不能大于20")
    ...
    @Length(max=50, message = "证件号码不能大于50")
